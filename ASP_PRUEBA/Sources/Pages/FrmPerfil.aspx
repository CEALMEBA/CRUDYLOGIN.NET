<%@ Page Title="" Language="C#" MasterPageFile="~/Sources/Pages/MP.Master" AutoEventWireup="true" CodeBehind="FrmPerfil.aspx.cs" Inherits="ASP_PRUEBA.Sources.Pages.FrmPerfil" %>
            ...
            <div class="container text-black-50 row">
                <div class="col-6 row justify-content-between">
                    <div class="align-items-center col-auto">
                        <fieldset>
                            ...
                            <br />
                            <div class="row">
                                <asp:Button runat="server" ID="BtnAplicar" CssClass="form-control btn btn-dark" Text="Aplicar Camnbios" OnClick="BtnAplicar_Click"/>
                            </div>
                        </fieldset>
                    </div>
                    <div class="row">
                ...
                <div class="col-6 row justify-content-center">
                    <div class="align-items-center col-auto">
                        ...
                        <fieldset>
                            <legend>
                                <i class="fa fa-key">Datos sesion</i>
                            </legend>
                            <asp:table runat="server" >
                             <asp:TableRow>
                               <asp:TableCell>
                                  <asp:Label runat="server" CssClass="col-form-label" Text="Usuario:" Enabled="false"></asp:Label>
                               </asp:TableCell>
                                <asp:TableCell>
                            ...
                            <asp:Table runat="server" ID="contrasenia" Visible="false">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>
                                        <asp:TextBox runat="server" CssClass="from-control" ID="tbClave" placeholder="New Password" TextMode="Password"></asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                                 <asp:TableRow>
                                    <asp:TableCell>
                                    ...
                                    <asp:TableCell>
                                        <asp:TextBox runat="server" CssClass="from-control" ID="tbClave2" placeholder="New Password Again" TextMode="Password"></asp:TextBox>
                                    </asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
