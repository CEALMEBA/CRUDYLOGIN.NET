...
namespace ASP_PRUEBA.Sources.Pages
{
    public partial class FrmPerfil : System.Web.UI.Page
    {
      ...
      readonly SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["conexion"].ConnectionString);
        ...
        protected void BtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            //El lbl fué corregido, como dicho en el vídeo, se habia usado el lblError, en lugar del asginado lblErrorClave
            ...
            {
                lblErrorClave.Text = "Los contraseñas no coinciden!";
            }
            else if (!letras.IsMatch(contraseniasinverificar))
            {
                lblErrorClave.Text = "Los contraseña debe contener letras!";
            }
            else if (!numeros.IsMatch(contraseniasinverificar))
            {
                lblErrorClave.Text = "Los contraseña debe contener números!";
            }
            else if (!especiales.IsMatch(contraseniasinverificar))
            {
                lblErrorClave.Text = "Los contraseña debe contener caracteres especiales!";
            }
            else
            {
                try
